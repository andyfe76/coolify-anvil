...
CMD ["/home/anvil/.local/bin/anvil-app-server", "--data-dir", "/app/data", "--uplink-key", "server_WUMI36BBIX2S4HTDRZR3MZS4-WG5XD5QBYR4LD4KH", "--port", "443", "--origin", "https://172.16.16.4", "--disable-tls", "--app", "/app/"]
