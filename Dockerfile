...
CMD ["/home/anvil/.local/bin/anvil-app-server", "--data-dir", "/app/data", "--ip", "0.0.0.0", "--port", "3030", "--origin", "https://test1.lansapp.net", "--disable-tls", "--forward-headers-insecure", "--add-hsts-headers", "--app", "/app/"]
