...
CMD ["/home/anvil/.local/bin/anvil-app-server", "--data-dir", "/app/data", "--uplink-key", "server_WUMI36BBIX2S4HTDRZR3MZS4-WG5XD5QBYR4LD4KH",  "--origin", "https://test1.lansapp.net", "--disable-tls", "--port", "80",  "--app", "/app/"]
