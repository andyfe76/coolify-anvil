...
CMD ["/home/anvil/.local/bin/anvil-app-server", "--data-dir", "/app/data", "--ip", "0.0.0.0", "--port", "443", "--origin", "https://localhost", "--disable-tls", "--forward-headers-insecure", "--add-hsts-headers", "--app", "/app/"]
